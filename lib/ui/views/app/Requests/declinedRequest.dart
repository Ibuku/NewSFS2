...
class DeclinedRequestScreen extends StatefulWidget {
  static const routeName = '/app/Requests/declinedRequest';
  @override
  _DeclineRequestScreenState createState() => _DeclineRequestScreenState();
}

class _DeclineRequestScreenState extends State<DeclinedRequestScreen> {
  var value = true;
